...
![image-20211231150656489](2021-12-31-ztncui-a-self-hosted-zerotier-web-controller.assets/image-20211231150656489.png)

点击该网络名就能进入该网络设置的设置页面。

![image-20211231152132452](2021-12-31-ztncui-a-self-hosted-zerotier-web-controller.assets/image-20211231152132452.png)

点击「Easy setup」按钮为网络设置网段。在该页面中点击「Generate network address」按钮可以随机生成网段，点击「Submit」按钮保存信息。

![image-20211231152152226](2021-12-31-ztncui-a-self-hosted-zerotier-web-controller.assets/image-20211231152152226.png)

点击「Private」按钮设置私有网络/公开网络。

![image-20211231152400238](2021-12-31-ztncui-a-self-hosted-zerotier-web-controller.assets/image-20211231152400238.png)

点击「Routes」按钮设置静态路由。

![image-20211231152422204](2021-12-31-ztncui-a-self-hosted-zerotier-web-controller.assets/image-20211231152422204.png)
...
![image-20211231152823640](2021-12-31-ztncui-a-self-hosted-zerotier-web-controller.assets/image-20211231152823640.png)
